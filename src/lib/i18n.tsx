...
const dictionaries: Record<Language, Dictionary> = {
  pt: {
    ...
    "gesture.letterI": "Letra I (LGP/ASL) 🤙",
    "gesture.letterL": "Letra L (LGP/ASL) 👆",
    "gesture.letterA": "Letra A (LGP/ASL) ✊",
    "gesture.letterD": "Letra D (LGP/ASL) ☝️",
    "gesture.letterF": "Letra F (LGP/ASL) 👌",
    "gesture.letterO": "Letra O (LGP/ASL) 👌",
    "gesture.rockOn": "Rock on 🤘",
    ...
    "faceId.sampleSaved": "Amostra guardada",
  ...
  en: {
    ...
    "gesture.letterI": "Letter I (ASL/LGP) 🤙",
    "gesture.letterL": "Letter L (ASL/LGP) 👆",
    "gesture.letterA": "Letter A (ASL/LGP) ✊",
    "gesture.letterD": "Letter D (ASL/LGP) ☝️",
    "gesture.letterF": "Letter F (ASL/LGP) 👌",
    ...
    "faceId.sampleSaved": "Sample saved",
